...
const SingleProfilePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("profile")
            .get(urlParams.singleProfileId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleProfileId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-10">
                ...
                <p>profile/{urlParams.singleProfileId}</p>
...
export default connect(mapState, mapDispatch)(SingleProfilePage);
